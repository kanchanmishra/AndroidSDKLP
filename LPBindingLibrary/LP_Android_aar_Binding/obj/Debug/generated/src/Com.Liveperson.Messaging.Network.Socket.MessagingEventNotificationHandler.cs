...
namespace Com.Liveperson.Messaging.Network.Socket {
	...
	public sealed partial class MessagingEventNotificationHandler : global::Com.Liveperson.Infra.Network.Socket.BaseResponseHandler {
		...
		static IntPtr id_handle_Lcom_liveperson_api_response_events_MessagingEventNotification_;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.liveperson.messaging.network.socket']/class[@name='MessagingEventNotificationHandler']/method[@name='handle' and count(parameter)=1 and parameter[1][@type='com.liveperson.api.response.events.MessagingEventNotification']]"
		[Register ("handle", "(Lcom/liveperson/api/response/events/MessagingEventNotification;)Z", "")]
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.liveperson.messaging.network.socket']/class[@name='MessagingEventNotificationHandler']/method[@name='parse' and count(parameter)=1 and parameter[1][@type='org.json.JSONObject']]"
		[Register ("parse", "(Lorg/json/JSONObject;)Lcom/liveperson/api/response/events/MessagingEventNotification;", "")]
