...
namespace Com.Liveperson.Infra.Database.Tables {
	...
	public partial interface IBaseTable : IJavaObject {
		...
		string CreateSQL {
			...
			[Register ("getCreateSQL", "()Ljava/lang/String;", "GetGetCreateSQLHandler:Com.Liveperson.Infra.Database.Tables.IBaseTableInvoker, LP_Binding1_JustLP")] get;
		}
		...
		string Name {
			...
			[Register ("getName", "()Ljava/lang/String;", "GetGetNameHandler:Com.Liveperson.Infra.Database.Tables.IBaseTableInvoker, LP_Binding1_JustLP")] get;
		}
		...
		[Register ("onTableUpgrade", "(Landroid/database/sqlite/SQLiteDatabase;II)V", "GetOnTableUpgrade_Landroid_database_sqlite_SQLiteDatabase_IIHandler:Com.Liveperson.Infra.Database.Tables.IBaseTableInvoker, LP_Binding1_JustLP")]
