...
namespace Com.Liveperson.Infra.Network.Http.Request {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.liveperson.infra.network.http.request']/class[@name='HttpHeadRequest']"
	[global::Android.Runtime.Register ("com/liveperson/infra/network/http/request/HttpHeadRequest", DoNotGenerateAcw=true)]
	public partial class HttpHeadRequest : global::Com.Liveperson.Infra.Network.Http.Request.HttpRequest {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/liveperson/infra/network/http/request/HttpHeadRequest", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (HttpHeadRequest); }
		}

		protected HttpHeadRequest (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Ljava_lang_String_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.liveperson.infra.network.http.request']/class[@name='HttpHeadRequest']/constructor[@name='HttpHeadRequest' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		[Register (".ctor", "(Ljava/lang/String;)V", "")]
		public unsafe HttpHeadRequest (string p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (HttpHeadRequest)) {
					SetHandle (
...
#pragma warning restore 0169
		...
		public override unsafe global::Com.Liveperson.Infra.Network.Http.Body.IHttpRequestBody RequestBody {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.liveperson.infra.network.http.request']/class[@name='HttpHeadRequest']/method[@name='getRequestBody' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.liveperson.infra.network.http.request']/class[@name='HttpHeadRequest']/method[@name='setBody' and count(parameter)=1 and parameter[1][@type='com.liveperson.infra.network.http.body.HttpRequestBody']]"
