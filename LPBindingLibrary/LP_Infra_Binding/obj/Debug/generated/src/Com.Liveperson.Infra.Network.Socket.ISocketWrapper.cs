...
namespace Com.Liveperson.Infra.Network.Socket {
	...
	public partial interface ISocketWrapper : IJavaObject {
		...
		[Register ("connect", "(Lcom/liveperson/infra/model/SocketConnectionParams;)V", "GetConnect_Lcom_liveperson_infra_model_SocketConnectionParams_Handler:Com.Liveperson.Infra.Network.Socket.ISocketWrapperInvoker, LP_Infra_Binding")]
		...
		[Register ("disconnect", "()V", "GetDisconnectHandler:Com.Liveperson.Infra.Network.Socket.ISocketWrapperInvoker, LP_Infra_Binding")]
		void Disconnect ();
		...
		[Register ("send", "(Ljava/lang/String;)V", "GetSend_Ljava_lang_String_Handler:Com.Liveperson.Infra.Network.Socket.ISocketWrapperInvoker, LP_Infra_Binding")]
		void Send (string p0);
