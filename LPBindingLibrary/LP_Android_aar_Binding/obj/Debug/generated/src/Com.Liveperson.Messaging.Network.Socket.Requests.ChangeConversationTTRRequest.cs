...
namespace Com.Liveperson.Messaging.Network.Socket.Requests {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.liveperson.messaging.network.socket.requests']/class[@name='ChangeConversationTTRRequest']"
	[global::Android.Runtime.Register ("com/liveperson/messaging/network/socket/requests/ChangeConversationTTRRequest", DoNotGenerateAcw=true)]
	public partial class ChangeConversationTTRRequest : global::Com.Liveperson.Api.Request.BaseAMSSocketRequest {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/liveperson/messaging/network/socket/requests/ChangeConversationTTRRequest", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (ChangeConversationTTRRequest); }
		}

		protected ChangeConversationTTRRequest (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Ljava_lang_String_Ljava_lang_String_Lcom_liveperson_api_response_types_TTRType_I;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.liveperson.messaging.network.socket.requests']/class[@name='ChangeConversationTTRRequest']/constructor[@name='ChangeConversationTTRRequest' and count(parameter)=4 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.String'] and parameter[3][@type='com.liveperson.api.response.types.TTRType'] and parameter[4][@type='int']]"
		[Register (".ctor", "(Ljava/lang/String;Ljava/lang/String;Lcom/liveperson/api/response/types/TTRType;I)V", "")]
		public unsafe ChangeConversationTTRRequest (string p0, string p1, global::Com.Liveperson.Api.Response.Types.TTRType p2, int p3)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (ChangeConversationTTRRequest)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Liveperson.Messaging.Network.Socket.Requests.ChangeConversationTTRRequest __this = global::Java.Lang.Object.GetObject<global::Com.Liveperson.Messaging.Network.Socket.Requests.ChangeConversationTTRRequest> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		protected override unsafe string Data {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.liveperson.messaging.network.socket.requests']/class[@name='ChangeConversationTTRRequest']/method[@name='getData' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		protected override unsafe string RequestName {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.liveperson.messaging.network.socket.requests']/class[@name='ChangeConversationTTRRequest']/method[@name='getRequestName' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		protected virtual unsafe global::Com.Liveperson.Infra.Network.Socket.BaseResponseHandler ResponseHandler {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.liveperson.messaging.network.socket.requests']/class[@name='ChangeConversationTTRRequest']/method[@name='getResponseHandler' and count(parameter)=0]"
