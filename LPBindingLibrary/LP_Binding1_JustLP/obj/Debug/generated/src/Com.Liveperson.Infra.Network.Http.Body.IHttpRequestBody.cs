...
namespace Com.Liveperson.Infra.Network.Http.Body {
	...
	public partial interface IHttpRequestBody : IJavaObject {
		...
		string ContentType {
			...
			[Register ("getContentType", "()Ljava/lang/String;", "GetGetContentTypeHandler:Com.Liveperson.Infra.Network.Http.Body.IHttpRequestBodyInvoker, LP_Binding1_JustLP")] get;
		}
		...
		bool IsString {
			...
			[Register ("isString", "()Z", "GetIsStringHandler:Com.Liveperson.Infra.Network.Http.Body.IHttpRequestBodyInvoker, LP_Binding1_JustLP")] get;
		}
		...
		[Register ("get", "()Ljava/lang/Object;", "GetGetHandler:Com.Liveperson.Infra.Network.Http.Body.IHttpRequestBodyInvoker, LP_Binding1_JustLP")]
