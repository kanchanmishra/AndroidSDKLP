...
namespace Com.Liveperson.Infra.Log.Logreporter.Loggos.Logsender {
	...
	public partial interface ILogSenderCallback : IJavaObject {
		...
		[Register ("onError", "(Ljava/util/List;Ljava/lang/Throwable;)V", "GetOnError_Ljava_util_List_Ljava_lang_Throwable_Handler:Com.Liveperson.Infra.Log.Logreporter.Loggos.Logsender.ILogSenderCallbackInvoker, LP_Binding1_JustLP")]
		...
		[Register ("onSuccess", "()V", "GetOnSuccessHandler:Com.Liveperson.Infra.Log.Logreporter.Loggos.Logsender.ILogSenderCallbackInvoker, LP_Binding1_JustLP")]
		void OnSuccess ();
