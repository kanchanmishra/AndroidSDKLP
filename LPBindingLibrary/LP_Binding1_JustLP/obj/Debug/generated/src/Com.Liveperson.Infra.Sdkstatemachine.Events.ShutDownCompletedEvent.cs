...
namespace Com.Liveperson.Infra.Sdkstatemachine.Events {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.liveperson.infra.sdkstatemachine.events']/class[@name='ShutDownCompletedEvent']"
	[global::Android.Runtime.Register ("com/liveperson/infra/sdkstatemachine/events/ShutDownCompletedEvent", DoNotGenerateAcw=true)]
	public partial class ShutDownCompletedEvent : global::Com.Liveperson.Infra.Statemachine.BaseEvent {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/liveperson/infra/sdkstatemachine/events/ShutDownCompletedEvent", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (ShutDownCompletedEvent); }
		}

		protected ShutDownCompletedEvent (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.liveperson.infra.sdkstatemachine.events']/class[@name='ShutDownCompletedEvent']/constructor[@name='ShutDownCompletedEvent' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe ShutDownCompletedEvent ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (ShutDownCompletedEvent)) {
					SetHandle (
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.liveperson.infra.sdkstatemachine.events']/class[@name='ShutDownCompletedEvent']/method[@name='accept' and count(parameter)=1 and parameter[1][@type='com.liveperson.infra.statemachine.interfaces.IState']]"
