...
namespace Com.Liveperson.Infra.Network.Socket {
	...
	public partial interface ISocketErrorCallback : IJavaObject {
		...
		[Register ("onFatalError", "()V", "GetOnFatalErrorHandler:Com.Liveperson.Infra.Network.Socket.ISocketErrorCallbackInvoker, LP_Infra_Binding")]
		void OnFatalError ();
		...
		[Register ("onParsingError", "()V", "GetOnParsingErrorHandler:Com.Liveperson.Infra.Network.Socket.ISocketErrorCallbackInvoker, LP_Infra_Binding")]
		void OnParsingError ();
