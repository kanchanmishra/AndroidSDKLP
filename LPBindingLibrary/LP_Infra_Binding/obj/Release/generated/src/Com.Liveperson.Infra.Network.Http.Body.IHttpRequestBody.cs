...
namespace Com.Liveperson.Infra.Network.Http.Body {
	...
	public partial interface IHttpRequestBody : IJavaObject {
		...
		string ContentType {
			...
			[Register ("getContentType", "()Ljava/lang/String;", "GetGetContentTypeHandler:Com.Liveperson.Infra.Network.Http.Body.IHttpRequestBodyInvoker, LP_Infra_Binding")] get;
		}
		...
		bool IsString {
			...
			[Register ("isString", "()Z", "GetIsStringHandler:Com.Liveperson.Infra.Network.Http.Body.IHttpRequestBodyInvoker, LP_Infra_Binding")] get;
		}
		...
		[Register ("get", "()Ljava/lang/Object;", "GetGetHandler:Com.Liveperson.Infra.Network.Http.Body.IHttpRequestBodyInvoker, LP_Infra_Binding")]
