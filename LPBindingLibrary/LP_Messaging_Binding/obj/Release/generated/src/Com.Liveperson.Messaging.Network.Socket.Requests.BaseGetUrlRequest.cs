...
namespace Com.Liveperson.Messaging.Network.Socket.Requests {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.liveperson.messaging.network.socket.requests']/class[@name='BaseGetUrlRequest']"
	[global::Android.Runtime.Register ("com/liveperson/messaging/network/socket/requests/BaseGetUrlRequest", DoNotGenerateAcw=true)]
	public abstract partial class BaseGetUrlRequest : global::Com.Liveperson.Api.Request.BaseAMSSocketRequest {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/liveperson/messaging/network/socket/requests/BaseGetUrlRequest", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (BaseGetUrlRequest); }
		}

		protected BaseGetUrlRequest (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Lcom_liveperson_messaging_Messaging_Ljava_lang_String_Lcom_liveperson_api_response_IOnUrlReady_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.liveperson.messaging.network.socket.requests']/class[@name='BaseGetUrlRequest']/constructor[@name='BaseGetUrlRequest' and count(parameter)=3 and parameter[1][@type='com.liveperson.messaging.Messaging'] and parameter[2][@type='java.lang.String'] and parameter[3][@type='com.liveperson.api.response.IOnUrlReady']]"
		[Register (".ctor", "(Lcom/liveperson/messaging/Messaging;Ljava/lang/String;Lcom/liveperson/api/response/IOnUrlReady;)V", "")]
...
#pragma warning restore 0169
		...
		protected override unsafe string RequestName {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.liveperson.messaging.network.socket.requests']/class[@name='BaseGetUrlRequest']/method[@name='getRequestName' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		protected virtual unsafe global::Com.Liveperson.Infra.Network.Socket.BaseResponseHandler ResponseHandler {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.liveperson.messaging.network.socket.requests']/class[@name='BaseGetUrlRequest']/method[@name='getResponseHandler' and count(parameter)=0]"
	...
	[global::Android.Runtime.Register ("com/liveperson/messaging/network/socket/requests/BaseGetUrlRequest", DoNotGenerateAcw=true)]
	internal partial class BaseGetUrlRequestInvoker : BaseGetUrlRequest {

		public BaseGetUrlRequestInvoker (IntPtr handle, JniHandleOwnership transfer) : base (handle, transfer) {}

		protected override global::System.Type ThresholdType {
			get { return typeof (BaseGetUrlRequestInvoker); }
		}
