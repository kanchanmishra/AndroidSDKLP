...
#pragma warning disable 0169
		static Delegate GetHandle_Ljava_lang_Object_Handler ()
		{
			if (cb_handle_Ljava_lang_Object_ == null)
				cb_handle_Ljava_lang_Object_ = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, IntPtr, bool>) n_Handle_Ljava_lang_Object_);
			return cb_handle_Ljava_lang_Object_;
		}

		static bool n_Handle_Ljava_lang_Object_ (IntPtr jnienv, IntPtr native__this, IntPtr native_p0)
		{
			global::Com.Liveperson.Infra.Network.Socket.BaseResponseHandler __this = global::Java.Lang.Object.GetObject<global::Com.Liveperson.Infra.Network.Socket.BaseResponseHandler> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.liveperson.infra.network.socket']/class[@name='BaseResponseHandler']/method[@name='handle' and count(parameter)=1 and parameter[1][@type='DATA']]"
		[Register ("handle", "(Ljava/lang/Object;)Z", "GetHandle_Ljava_lang_Object_Handler")]
		protected abstract bool Handle (global::Java.Lang.Object p0);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.liveperson.infra.network.socket']/class[@name='BaseResponseHandler']/method[@name='parse' and count(parameter)=1 and parameter[1][@type='org.json.JSONObject']]"
		[Register ("parse", "(Lorg/json/JSONObject;)Ljava/lang/Object;", "GetParse_Lorg_json_JSONObject_Handler")]
		protected abstract global::Java.Lang.Object Parse (global::Org.Json.JSONObject p0);
	...
	internal partial class BaseResponseHandlerInvoker : BaseResponseHandler {
		...
		static IntPtr id_handle_Ljava_lang_Object_;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.liveperson.infra.network.socket']/class[@name='BaseResponseHandler']/method[@name='handle' and count(parameter)=1 and parameter[1][@type='DATA']]"
		[Register ("handle", "(Ljava/lang/Object;)Z", "GetHandle_Ljava_lang_Object_Handler")]
		protected override unsafe bool Handle (global::Java.Lang.Object p0)
		{
			if (id_handle_Ljava_lang_Object_ == IntPtr.Zero)
				id_handle_Ljava_lang_Object_ = JNIEnv.GetMethodID (class_ref, "handle", "(Ljava/lang/Object;)Z");
			IntPtr native_p0 = JNIEnv.ToLocalJniHandle (p0);
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (native_p0);
				bool __ret = JNIEnv.CallBooleanMethod (((global::Java.Lang.Object) this).Handle, id_handle_Ljava_lang_Object_, __args);
				return __ret;
			} finally {
				JNIEnv.DeleteLocalRef (native_p0);
			}
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.liveperson.infra.network.socket']/class[@name='BaseResponseHandler']/method[@name='parse' and count(parameter)=1 and parameter[1][@type='org.json.JSONObject']]"
		[Register ("parse", "(Lorg/json/JSONObject;)Ljava/lang/Object;", "GetParse_Lorg_json_JSONObject_Handler")]
		protected override unsafe global::Java.Lang.Object Parse (global::Org.Json.JSONObject p0)
		{
			if (id_parse_Lorg_json_JSONObject_ == IntPtr.Zero)
				id_parse_Lorg_json_JSONObject_ = JNIEnv.GetMethodID (class_ref, "parse", "(Lorg/json/JSONObject;)Ljava/lang/Object;");
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);
				global::Java.Lang.Object __ret = (Java.Lang.Object) global::Java.Lang.Object.GetObject<global::Java.Lang.Object> (JNIEnv.CallObjectMethod (((global::Java.Lang.Object) this).Handle, id_parse_Lorg_json_JSONObject_, __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
			}
		}
