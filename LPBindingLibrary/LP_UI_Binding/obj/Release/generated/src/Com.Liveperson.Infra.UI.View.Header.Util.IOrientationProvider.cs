...
namespace Com.Liveperson.Infra.UI.View.Header.Util {
	...
	public partial interface IOrientationProvider : IJavaObject {
		...
		[Register ("getOrientation", "(Landroid/support/v7/widget/RecyclerView;)I", "GetGetOrientation_Landroid_support_v7_widget_RecyclerView_Handler:Com.Liveperson.Infra.UI.View.Header.Util.IOrientationProviderInvoker, LP_UI_Binding")]
		...
		[Register ("isReverseLayout", "(Landroid/support/v7/widget/RecyclerView;)Z", "GetIsReverseLayout_Landroid_support_v7_widget_RecyclerView_Handler:Com.Liveperson.Infra.UI.View.Header.Util.IOrientationProviderInvoker, LP_UI_Binding")]
