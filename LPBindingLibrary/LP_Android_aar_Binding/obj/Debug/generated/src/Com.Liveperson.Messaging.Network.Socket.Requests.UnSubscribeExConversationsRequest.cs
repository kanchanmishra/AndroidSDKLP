...
namespace Com.Liveperson.Messaging.Network.Socket.Requests {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.liveperson.messaging.network.socket.requests']/class[@name='UnSubscribeExConversationsRequest']"
	[global::Android.Runtime.Register ("com/liveperson/messaging/network/socket/requests/UnSubscribeExConversationsRequest", DoNotGenerateAcw=true)]
	public partial class UnSubscribeExConversationsRequest : global::Com.Liveperson.Api.Request.BaseAMSSocketRequest {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/liveperson/messaging/network/socket/requests/UnSubscribeExConversationsRequest", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (UnSubscribeExConversationsRequest); }
		}

		protected UnSubscribeExConversationsRequest (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Ljava_lang_String_Ljava_lang_String_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.liveperson.messaging.network.socket.requests']/class[@name='UnSubscribeExConversationsRequest']/constructor[@name='UnSubscribeExConversationsRequest' and count(parameter)=2 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.String']]"
		[Register (".ctor", "(Ljava/lang/String;Ljava/lang/String;)V", "")]
		public unsafe UnSubscribeExConversationsRequest (string p0, string p1)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (UnSubscribeExConversationsRequest)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Liveperson.Messaging.Network.Socket.Requests.UnSubscribeExConversationsRequest __this = global::Java.Lang.Object.GetObject<global::Com.Liveperson.Messaging.Network.Socket.Requests.UnSubscribeExConversationsRequest> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		protected override unsafe string Data {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.liveperson.messaging.network.socket.requests']/class[@name='UnSubscribeExConversationsRequest']/method[@name='getData' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		protected override unsafe string RequestName {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.liveperson.messaging.network.socket.requests']/class[@name='UnSubscribeExConversationsRequest']/method[@name='getRequestName' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		protected virtual unsafe global::Com.Liveperson.Infra.Network.Socket.BaseResponseHandler ResponseHandler {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.liveperson.messaging.network.socket.requests']/class[@name='UnSubscribeExConversationsRequest']/method[@name='getResponseHandler' and count(parameter)=0]"
