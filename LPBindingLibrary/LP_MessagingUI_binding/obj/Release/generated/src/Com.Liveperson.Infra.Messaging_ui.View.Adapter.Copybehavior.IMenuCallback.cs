...
namespace Com.Liveperson.Infra.Messaging_ui.View.Adapter.Copybehavior {
	...
	public partial interface IMenuCallback : IJavaObject {
		...
		[Register ("onMenuClose", "()V", "GetOnMenuCloseHandler:Com.Liveperson.Infra.Messaging_ui.View.Adapter.Copybehavior.IMenuCallbackInvoker, LP_MessagingUI_binding")]
		void OnMenuClose ();
		...
		[Register ("onMenuOpen", "()V", "GetOnMenuOpenHandler:Com.Liveperson.Infra.Messaging_ui.View.Adapter.Copybehavior.IMenuCallbackInvoker, LP_MessagingUI_binding")]
		void OnMenuOpen ();
