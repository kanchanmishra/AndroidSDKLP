...
namespace Com.Liveperson.Infra.Messaging_ui.Uicomponents.Structuredcontent {
	...
	public partial interface IQRActionClickListener : IJavaObject {
		...
		[Register ("onClick", "()V", "GetOnClickHandler:Com.Liveperson.Infra.Messaging_ui.Uicomponents.Structuredcontent.IQRActionClickListenerInvoker, LP_MessagingUI_binding")]
		void OnClick ();
