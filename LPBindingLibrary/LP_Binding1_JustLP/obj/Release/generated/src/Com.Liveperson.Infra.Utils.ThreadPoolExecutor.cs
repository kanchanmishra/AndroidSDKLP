...
namespace Com.Liveperson.Infra.Utils {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.liveperson.infra.utils']/class[@name='ThreadPoolExecutor']"
	[global::Android.Runtime.Register ("com/liveperson/infra/utils/ThreadPoolExecutor", DoNotGenerateAcw=true)]
	public partial class ThreadPoolExecutor : global::Java.Lang.Object {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/liveperson/infra/utils/ThreadPoolExecutor", ref java_class_handle);
			}
		}
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.liveperson.infra.utils']/class[@name='ThreadPoolExecutor']/constructor[@name='ThreadPoolExecutor' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.liveperson.infra.utils']/class[@name='ThreadPoolExecutor']/method[@name='execute' and count(parameter)=1 and parameter[1][@type='java.lang.Runnable']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.liveperson.infra.utils']/class[@name='ThreadPoolExecutor']/method[@name='executeDelayed' and count(parameter)=2 and parameter[1][@type='java.lang.Runnable'] and parameter[2][@type='long']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.liveperson.infra.utils']/class[@name='ThreadPoolExecutor']/method[@name='killAll' and count(parameter)=0]"
		[Register ("killAll", "()V", "")]
