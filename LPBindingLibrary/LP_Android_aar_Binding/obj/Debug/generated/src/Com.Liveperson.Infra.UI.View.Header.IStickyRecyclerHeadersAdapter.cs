...
namespace Com.Liveperson.Infra.UI.View.Header {
	...
	public partial interface IStickyRecyclerHeadersAdapter : IJavaObject {
		...
		int ItemCount {
			...
			[Register ("getItemCount", "()I", "GetGetItemCountHandler:Com.Liveperson.Infra.UI.View.Header.IStickyRecyclerHeadersAdapterInvoker, LP_Android_aar_Binding")] get;
		}
		...
		[Register ("getHeaderId", "(I)J", "GetGetHeaderId_IHandler:Com.Liveperson.Infra.UI.View.Header.IStickyRecyclerHeadersAdapterInvoker, LP_Android_aar_Binding")]
		...
		[Register ("onBindHeaderViewHolder", "(Landroid/support/v7/widget/RecyclerView$ViewHolder;I)V", "GetOnBindHeaderViewHolder_Landroid_support_v7_widget_RecyclerView_ViewHolder_IHandler:Com.Liveperson.Infra.UI.View.Header.IStickyRecyclerHeadersAdapterInvoker, LP_Android_aar_Binding")]
		...
		[Register ("onCreateHeaderViewHolder", "(Landroid/view/ViewGroup;)Landroid/support/v7/widget/RecyclerView$ViewHolder;", "GetOnCreateHeaderViewHolder_Landroid_view_ViewGroup_Handler:Com.Liveperson.Infra.UI.View.Header.IStickyRecyclerHeadersAdapterInvoker, LP_Android_aar_Binding")]
