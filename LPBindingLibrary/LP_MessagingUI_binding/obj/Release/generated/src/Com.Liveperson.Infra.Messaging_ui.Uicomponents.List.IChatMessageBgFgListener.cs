...
namespace Com.Liveperson.Infra.Messaging_ui.Uicomponents.List {
	...
	public partial interface IChatMessageBgFgListener : IJavaObject {
		...
		[Register ("onBackground", "()V", "GetOnBackgroundHandler:Com.Liveperson.Infra.Messaging_ui.Uicomponents.List.IChatMessageBgFgListenerInvoker, LP_MessagingUI_binding")]
		void OnBackground ();
		...
		[Register ("onForeground", "()V", "GetOnForegroundHandler:Com.Liveperson.Infra.Messaging_ui.Uicomponents.List.IChatMessageBgFgListenerInvoker, LP_MessagingUI_binding")]
		void OnForeground ();
