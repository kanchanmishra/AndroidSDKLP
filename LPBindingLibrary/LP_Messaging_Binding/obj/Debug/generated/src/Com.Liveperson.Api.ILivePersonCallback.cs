...
#pragma warning restore 0169
	...
	public partial interface ILivePersonCallback : IJavaObject {
		...
		[Register ("onAgentAvatarTapped", "(Lcom/liveperson/messaging/model/AgentData;)V", "GetOnAgentAvatarTapped_Lcom_liveperson_messaging_model_AgentData_Handler:Com.Liveperson.Api.ILivePersonCallbackInvoker, LP_Messaging_Binding")]
		...
		[Register ("onAgentDetailsChanged", "(Lcom/liveperson/messaging/model/AgentData;)V", "GetOnAgentDetailsChanged_Lcom_liveperson_messaging_model_AgentData_Handler:Com.Liveperson.Api.ILivePersonCallbackInvoker, LP_Messaging_Binding")]
		...
		[Register ("onAgentTyping", "(Z)V", "GetOnAgentTyping_ZHandler:Com.Liveperson.Api.ILivePersonCallbackInvoker, LP_Messaging_Binding")]
		...
		[Register ("onConnectionChanged", "(Z)V", "GetOnConnectionChanged_ZHandler:Com.Liveperson.Api.ILivePersonCallbackInvoker, LP_Messaging_Binding")]
		...
		[Register ("onConversationMarkedAsNormal", "()V", "GetOnConversationMarkedAsNormalHandler:Com.Liveperson.Api.ILivePersonCallbackInvoker, LP_Messaging_Binding")]
		...
		[Register ("onConversationMarkedAsUrgent", "()V", "GetOnConversationMarkedAsUrgentHandler:Com.Liveperson.Api.ILivePersonCallbackInvoker, LP_Messaging_Binding")]
...
[Obsolete (@"deprecated")]
		[Register ("onConversationResolved", "()V", "GetOnConversationResolvedHandler:Com.Liveperson.Api.ILivePersonCallbackInvoker, LP_Messaging_Binding")]
...
[Obsolete (@"deprecated")]
		[Register ("onConversationResolved", "(Lcom/liveperson/api/response/types/CloseReason;)V", "GetOnConversationResolved_Lcom_liveperson_api_response_types_CloseReason_Handler:Com.Liveperson.Api.ILivePersonCallbackInvoker, LP_Messaging_Binding")]
		...
		[Register ("onConversationResolved", "(Lcom/liveperson/api/sdk/LPConversationData;)V", "GetOnConversationResolved_Lcom_liveperson_api_sdk_LPConversationData_Handler:Com.Liveperson.Api.ILivePersonCallbackInvoker, LP_Messaging_Binding")]
...
[Obsolete (@"deprecated")]
		[Register ("onConversationStarted", "()V", "GetOnConversationStartedHandler:Com.Liveperson.Api.ILivePersonCallbackInvoker, LP_Messaging_Binding")]
		...
		[Register ("onConversationStarted", "(Lcom/liveperson/api/sdk/LPConversationData;)V", "GetOnConversationStarted_Lcom_liveperson_api_sdk_LPConversationData_Handler:Com.Liveperson.Api.ILivePersonCallbackInvoker, LP_Messaging_Binding")]
		...
		[Register ("onCsatDismissed", "()V", "GetOnCsatDismissedHandler:Com.Liveperson.Api.ILivePersonCallbackInvoker, LP_Messaging_Binding")]
		...
		[Register ("onCsatLaunched", "()V", "GetOnCsatLaunchedHandler:Com.Liveperson.Api.ILivePersonCallbackInvoker, LP_Messaging_Binding")]
		void OnCsatLaunched ();
		...
		[Register ("onCsatSkipped", "()V", "GetOnCsatSkippedHandler:Com.Liveperson.Api.ILivePersonCallbackInvoker, LP_Messaging_Binding")]
		void OnCsatSkipped ();
		...
		[Register ("onCsatSubmitted", "(Ljava/lang/String;)V", "GetOnCsatSubmitted_Ljava_lang_String_Handler:Com.Liveperson.Api.ILivePersonCallbackInvoker, LP_Messaging_Binding")]
		...
		[Register ("onError", "(Lcom/liveperson/messaging/TaskType;Ljava/lang/String;)V", "GetOnError_Lcom_liveperson_messaging_TaskType_Ljava_lang_String_Handler:Com.Liveperson.Api.ILivePersonCallbackInvoker, LP_Messaging_Binding")]
		...
		[Register ("onOfflineHoursChanges", "(Z)V", "GetOnOfflineHoursChanges_ZHandler:Com.Liveperson.Api.ILivePersonCallbackInvoker, LP_Messaging_Binding")]
		...
		[Register ("onStructuredContentLinkClicked", "(Ljava/lang/String;)V", "GetOnStructuredContentLinkClicked_Ljava_lang_String_Handler:Com.Liveperson.Api.ILivePersonCallbackInvoker, LP_Messaging_Binding")]
		...
		[Register ("onTokenExpired", "()V", "GetOnTokenExpiredHandler:Com.Liveperson.Api.ILivePersonCallbackInvoker, LP_Messaging_Binding")]
		void OnTokenExpired ();
		...
		[Register ("onUnauthenticatedUserExpired", "()V", "GetOnUnauthenticatedUserExpiredHandler:Com.Liveperson.Api.ILivePersonCallbackInvoker, LP_Messaging_Binding")]
		...
		[Register ("onUserActionOnPreventedPermission", "(Lcom/liveperson/api/sdk/PermissionType;)V", "GetOnUserActionOnPreventedPermission_Lcom_liveperson_api_sdk_PermissionType_Handler:Com.Liveperson.Api.ILivePersonCallbackInvoker, LP_Messaging_Binding")]
		...
		[Register ("onUserDeniedPermission", "(Lcom/liveperson/api/sdk/PermissionType;Z)V", "GetOnUserDeniedPermission_Lcom_liveperson_api_sdk_PermissionType_ZHandler:Com.Liveperson.Api.ILivePersonCallbackInvoker, LP_Messaging_Binding")]
