...
namespace Com.Liveperson.Messaging.Background.Filesharing.Image {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.liveperson.messaging.background.filesharing.image']/class[@name='DownloadImageTask']"
	[global::Android.Runtime.Register ("com/liveperson/messaging/background/filesharing/image/DownloadImageTask", DoNotGenerateAcw=true)]
	public partial class DownloadImageTask : global::Com.Liveperson.Messaging.Background.DownloadFileTask {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/liveperson/messaging/background/filesharing/image/DownloadImageTask", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (DownloadImageTask); }
		}

		protected DownloadImageTask (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Lcom_liveperson_messaging_background_filesharing_DownloadFileTaskBundle_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.liveperson.messaging.background.filesharing.image']/class[@name='DownloadImageTask']/constructor[@name='DownloadImageTask' and count(parameter)=1 and parameter[1][@type='com.liveperson.messaging.background.filesharing.DownloadFileTaskBundle']]"
		[Register (".ctor", "(Lcom/liveperson/messaging/background/filesharing/DownloadFileTaskBundle;)V", "")]
		public unsafe DownloadImageTask (global::Com.Liveperson.Messaging.Background.Filesharing.DownloadFileTaskBundle p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (DownloadImageTask)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Liveperson.Messaging.Background.Filesharing.Image.DownloadImageTask __this = global::Java.Lang.Object.GetObject<global::Com.Liveperson.Messaging.Background.Filesharing.Image.DownloadImageTask> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.liveperson.messaging.background.filesharing.image']/class[@name='DownloadImageTask']/method[@name='saveFileToDisk' and count(parameter)=1 and parameter[1][@type='byte[]']]"
