...
namespace Com.Liveperson.Messaging.Model {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.liveperson.messaging.model']/class[@name='SynchronizedAmsConnectionUpdateCallback']"
	[global::Android.Runtime.Register ("com/liveperson/messaging/model/SynchronizedAmsConnectionUpdateCallback", DoNotGenerateAcw=true)]
	public partial class SynchronizedAmsConnectionUpdateCallback : global::Java.Lang.Object, global::Com.Liveperson.Infra.ICommand {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/liveperson/messaging/model/SynchronizedAmsConnectionUpdateCallback", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (SynchronizedAmsConnectionUpdateCallback); }
		}

		protected SynchronizedAmsConnectionUpdateCallback (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Lcom_liveperson_messaging_controller_ConnectionsController_Ljava_lang_String_Ljava_lang_Runnable_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.liveperson.messaging.model']/class[@name='SynchronizedAmsConnectionUpdateCallback']/constructor[@name='SynchronizedAmsConnectionUpdateCallback' and count(parameter)=3 and parameter[1][@type='com.liveperson.messaging.controller.ConnectionsController'] and parameter[2][@type='java.lang.String'] and parameter[3][@type='java.lang.Runnable']]"
		[Register (".ctor", "(Lcom/liveperson/messaging/controller/ConnectionsController;Ljava/lang/String;Ljava/lang/Runnable;)V", "")]
		public unsafe SynchronizedAmsConnectionUpdateCallback (global::Com.Liveperson.Messaging.Controller.ConnectionsController p0, string p1, global::Java.Lang.IRunnable p2)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (SynchronizedAmsConnectionUpdateCallback)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Liveperson.Messaging.Model.SynchronizedAmsConnectionUpdateCallback __this = global::Java.Lang.Object.GetObject<global::Com.Liveperson.Messaging.Model.SynchronizedAmsConnectionUpdateCallback> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			__this.Execute ();
		}
#pragma warning restore 0169

		static IntPtr id_execute;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.liveperson.messaging.model']/class[@name='SynchronizedAmsConnectionUpdateCallback']/method[@name='execute' and count(parameter)=0]"
