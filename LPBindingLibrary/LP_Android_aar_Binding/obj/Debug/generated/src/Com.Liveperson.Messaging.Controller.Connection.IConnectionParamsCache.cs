...
namespace Com.Liveperson.Messaging.Controller.Connection {
	...
	public partial interface IConnectionParamsCache : IJavaObject {
		...
		bool AutoMessagesFeatureEnabled {
			...
			[Register ("isAutoMessagesFeatureEnabled", "()Z", "GetIsAutoMessagesFeatureEnabledHandler:Com.Liveperson.Messaging.Controller.Connection.IConnectionParamsCacheInvoker, LP_Android_aar_Binding")] get;
			...
			[Register ("setAutoMessagesFeatureEnabled", "(Z)V", "GetSetAutoMessagesFeatureEnabled_ZHandler:Com.Liveperson.Messaging.Controller.Connection.IConnectionParamsCacheInvoker, LP_Android_aar_Binding")] set;
		}
		...
		bool FullConnectionFlowRequired {
			...
			[Register ("isFullConnectionFlowRequired", "()Z", "GetIsFullConnectionFlowRequiredHandler:Com.Liveperson.Messaging.Controller.Connection.IConnectionParamsCacheInvoker, LP_Android_aar_Binding")] get;
			...
			[Register ("setFullConnectionFlowRequired", "(Z)V", "GetSetFullConnectionFlowRequired_ZHandler:Com.Liveperson.Messaging.Controller.Connection.IConnectionParamsCacheInvoker, LP_Android_aar_Binding")] set;
		}
		...
		bool IsCsdsFilled {
			...
			[Register ("isCsdsFilled", "()Z", "GetIsCsdsFilledHandler:Com.Liveperson.Messaging.Controller.Connection.IConnectionParamsCacheInvoker, LP_Android_aar_Binding")] get;
		}
		...
		bool IsVersionsCompatible {
			...
			[Register ("isVersionsCompatible", "()Z", "GetIsVersionsCompatibleHandler:Com.Liveperson.Messaging.Controller.Connection.IConnectionParamsCacheInvoker, LP_Android_aar_Binding")] get;
		}
		...
		[Register ("getServiceDomain", "(Ljava/lang/String;)Ljava/lang/String;", "GetGetServiceDomain_Ljava_lang_String_Handler:Com.Liveperson.Messaging.Controller.Connection.IConnectionParamsCacheInvoker, LP_Android_aar_Binding")]
		...
		[Register ("updateAcCdnVersion", "(Ljava/lang/String;)Z", "GetUpdateAcCdnVersion_Ljava_lang_String_Handler:Com.Liveperson.Messaging.Controller.Connection.IConnectionParamsCacheInvoker, LP_Android_aar_Binding")]
		...
		[Register ("updateCsdsDomains", "(Ljava/util/HashMap;)Z", "GetUpdateCsdsDomains_Ljava_util_HashMap_Handler:Com.Liveperson.Messaging.Controller.Connection.IConnectionParamsCacheInvoker, LP_Android_aar_Binding")]
		...
		[Register ("updateLeCdnVersion", "(Ljava/lang/String;)Z", "GetUpdateLeCdnVersion_Ljava_lang_String_Handler:Com.Liveperson.Messaging.Controller.Connection.IConnectionParamsCacheInvoker, LP_Android_aar_Binding")]
