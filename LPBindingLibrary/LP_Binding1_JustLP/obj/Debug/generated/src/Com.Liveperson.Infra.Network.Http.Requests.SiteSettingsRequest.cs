...
namespace Com.Liveperson.Infra.Network.Http.Requests {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.liveperson.infra.network.http.requests']/class[@name='SiteSettingsRequest']"
	[global::Android.Runtime.Register ("com/liveperson/infra/network/http/requests/SiteSettingsRequest", DoNotGenerateAcw=true)]
	public partial class SiteSettingsRequest : global::Java.Lang.Object, global::Com.Liveperson.Infra.ICommand {


		static IntPtr TAG_jfieldId;

		// Metadata.xml XPath field reference: path="/api/package[@name='com.liveperson.infra.network.http.requests']/class[@name='SiteSettingsRequest']/field[@name='TAG']"
		[Register ("TAG")]
		...
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/liveperson/infra/network/http/requests/SiteSettingsRequest", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (SiteSettingsRequest); }
		}

		protected SiteSettingsRequest (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Ljava_lang_String_Ljava_lang_String_Ljava_util_List_Lcom_liveperson_infra_ICallback_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.liveperson.infra.network.http.requests']/class[@name='SiteSettingsRequest']/constructor[@name='SiteSettingsRequest' and count(parameter)=4 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.String'] and parameter[3][@type='java.util.List&lt;java.lang.String&gt;'] and parameter[4][@type='com.liveperson.infra.ICallback']]"
		[Register (".ctor", "(Ljava/lang/String;Ljava/lang/String;Ljava/util/List;Lcom/liveperson/infra/ICallback;)V", "")]
		public unsafe SiteSettingsRequest (string p0, string p1, global::System.Collections.Generic.IList<string> p2, global::Com.Liveperson.Infra.ICallback p3)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (SiteSettingsRequest)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Liveperson.Infra.Network.Http.Requests.SiteSettingsRequest __this = global::Java.Lang.Object.GetObject<global::Com.Liveperson.Infra.Network.Http.Requests.SiteSettingsRequest> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			__this.Execute ();
		}
#pragma warning restore 0169

		static IntPtr id_execute;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.liveperson.infra.network.http.requests']/class[@name='SiteSettingsRequest']/method[@name='execute' and count(parameter)=0]"
