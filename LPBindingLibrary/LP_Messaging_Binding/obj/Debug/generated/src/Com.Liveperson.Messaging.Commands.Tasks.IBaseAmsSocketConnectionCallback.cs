...
namespace Com.Liveperson.Messaging.Commands.Tasks {
	...
	public partial interface IBaseAmsSocketConnectionCallback : IJavaObject {
		...
		[Register ("onTaskError", "(Lcom/liveperson/messaging/SocketTaskType;Ljava/lang/Throwable;)V", "GetOnTaskError_Lcom_liveperson_messaging_SocketTaskType_Ljava_lang_Throwable_Handler:Com.Liveperson.Messaging.Commands.Tasks.IBaseAmsSocketConnectionCallbackInvoker, LP_Messaging_Binding")]
		...
		[Register ("onTaskSuccess", "()V", "GetOnTaskSuccessHandler:Com.Liveperson.Messaging.Commands.Tasks.IBaseAmsSocketConnectionCallbackInvoker, LP_Messaging_Binding")]
		void OnTaskSuccess ();
