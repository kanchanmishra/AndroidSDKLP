...
namespace Com.Liveperson.Infra.Network {
	...
	public partial interface IBackOff : IJavaObject {
		...
		long NextBackOffMillis {
			...
			[Register ("getNextBackOffMillis", "()J", "GetGetNextBackOffMillisHandler:Com.Liveperson.Infra.Network.IBackOffInvoker, LP_Infra_Binding")] get;
		}
		...
		int RetryNumber {
			...
			[Register ("getRetryNumber", "()I", "GetGetRetryNumberHandler:Com.Liveperson.Infra.Network.IBackOffInvoker, LP_Infra_Binding")] get;
		}
		...
		[Register ("calculateNextBackOffMillis", "()V", "GetCalculateNextBackOffMillisHandler:Com.Liveperson.Infra.Network.IBackOffInvoker, LP_Infra_Binding")]
		...
		[Register ("reset", "()V", "GetResetHandler:Com.Liveperson.Infra.Network.IBackOffInvoker, LP_Infra_Binding")]
		void Reset ();
