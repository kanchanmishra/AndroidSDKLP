...
namespace Com.Liveperson.Infra.Network.Http.Request {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.liveperson.infra.network.http.request']/class[@name='HttpPutRequest']"
	[global::Android.Runtime.Register ("com/liveperson/infra/network/http/request/HttpPutRequest", DoNotGenerateAcw=true)]
	public partial class HttpPutRequest : global::Com.Liveperson.Infra.Network.Http.Request.HttpRequest {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/liveperson/infra/network/http/request/HttpPutRequest", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (HttpPutRequest); }
		}

		protected HttpPutRequest (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Ljava_lang_String_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.liveperson.infra.network.http.request']/class[@name='HttpPutRequest']/constructor[@name='HttpPutRequest' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		[Register (".ctor", "(Ljava/lang/String;)V", "")]
		public unsafe HttpPutRequest (string p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (HttpPutRequest)) {
					SetHandle (
...
#pragma warning restore 0169
		...
		public override unsafe global::Com.Liveperson.Infra.Network.Http.Body.IHttpRequestBody RequestBody {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.liveperson.infra.network.http.request']/class[@name='HttpPutRequest']/method[@name='getRequestBody' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.liveperson.infra.network.http.request']/class[@name='HttpPutRequest']/method[@name='setBody' and count(parameter)=1 and parameter[1][@type='com.liveperson.infra.network.http.body.HttpRequestBody']]"
