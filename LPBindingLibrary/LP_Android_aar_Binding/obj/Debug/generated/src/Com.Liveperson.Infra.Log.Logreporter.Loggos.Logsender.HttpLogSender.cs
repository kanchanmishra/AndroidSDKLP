...
namespace Com.Liveperson.Infra.Log.Logreporter.Loggos.Logsender {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.liveperson.infra.log.logreporter.loggos.logsender']/class[@name='HttpLogSender']"
	[global::Android.Runtime.Register ("com/liveperson/infra/log/logreporter/loggos/logsender/HttpLogSender", DoNotGenerateAcw=true)]
	public partial class HttpLogSender : global::Com.Liveperson.Infra.Log.Logreporter.Loggos.Logsender.LogSender {


		static IntPtr TAG_jfieldId;

		// Metadata.xml XPath field reference: path="/api/package[@name='com.liveperson.infra.log.logreporter.loggos.logsender']/class[@name='HttpLogSender']/field[@name='TAG']"
		[Register ("TAG")]
		...
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/liveperson/infra/log/logreporter/loggos/logsender/HttpLogSender", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (HttpLogSender); }
		}

		protected HttpLogSender (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.liveperson.infra.log.logreporter.loggos.logsender']/class[@name='HttpLogSender']/constructor[@name='HttpLogSender' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe HttpLogSender ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (HttpLogSender)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Liveperson.Infra.Log.Logreporter.Loggos.Logsender.HttpLogSender __this = global::Java.Lang.Object.GetObject<global::Com.Liveperson.Infra.Log.Logreporter.Loggos.Logsender.HttpLogSender> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
		...
		public override unsafe void SendBulk (string p0, global::System.Collections.Generic.IList<global::Com.Liveperson.Infra.Log.Logreporter.Loggos.LoggosMessage> p1, global::System.Collections.Generic.IList<string> p2)
		{
			...
			try {
				...
				if (((object) this).GetType () == ThresholdType)
					...
					JNIEnv.CallNonvirtualVoidMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "sendBulk", "(Ljava/lang/String;Ljava/util/List;Ljava/util/List;)V"), __args);
			} finally {
