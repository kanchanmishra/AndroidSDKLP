...
namespace Com.Liveperson.Infra.Network.Socket {
	...
	public partial interface ISocketErrorCallback : IJavaObject {
		...
		[Register ("onFatalError", "()V", "GetOnFatalErrorHandler:Com.Liveperson.Infra.Network.Socket.ISocketErrorCallbackInvoker, LP_Binding1_JustLP")]
		void OnFatalError ();
		...
		[Register ("onParsingError", "()V", "GetOnParsingErrorHandler:Com.Liveperson.Infra.Network.Socket.ISocketErrorCallbackInvoker, LP_Binding1_JustLP")]
		void OnParsingError ();
