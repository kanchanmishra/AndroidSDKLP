...
namespace Com.Liveperson.Infra.Statemachine.Interfaces {
	...
	public partial interface IState : IJavaObject {
		...
		[Register ("actionOnEntry", "()V", "GetActionOnEntryHandler:Com.Liveperson.Infra.Statemachine.Interfaces.IStateInvoker, LP_Infra_Binding")]
		void ActionOnEntry ();
		...
		[Register ("actionOnExit", "()V", "GetActionOnExitHandler:Com.Liveperson.Infra.Statemachine.Interfaces.IStateInvoker, LP_Infra_Binding")]
		void ActionOnExit ();
