...
namespace Com.Liveperson.Messaging.Structuredcontent.Model.Elements.Basic {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.liveperson.messaging.structuredcontent.model.elements.basic']/class[@name='WebViewElement']"
	[global::Android.Runtime.Register ("com/liveperson/messaging/structuredcontent/model/elements/basic/WebViewElement", DoNotGenerateAcw=true)]
	public partial class WebViewElement : global::Com.Liveperson.Messaging.Structuredcontent.Model.Elements.ActionableElement {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/liveperson/messaging/structuredcontent/model/elements/basic/WebViewElement", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (WebViewElement); }
		}

		protected WebViewElement (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.liveperson.messaging.structuredcontent.model.elements.basic']/class[@name='WebViewElement']/constructor[@name='WebViewElement' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe WebViewElement ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (WebViewElement)) {
					SetHandle (
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.liveperson.messaging.structuredcontent.model.elements.basic']/class[@name='WebViewElement']/constructor[@name='WebViewElement' and count(parameter)=1 and parameter[1][@type='org.json.JSONObject']]"
		[Register (".ctor", "(Lorg/json/JSONObject;)V", "")]
		public unsafe WebViewElement (global::Org.Json.JSONObject p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
				return;
...
#pragma warning disable 0169
		...
		{
			global::Com.Liveperson.Messaging.Structuredcontent.Model.Elements.Basic.WebViewElement __this = global::Java.Lang.Object.GetObject<global::Com.Liveperson.Messaging.Structuredcontent.Model.Elements.Basic.WebViewElement> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe string Url {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.liveperson.messaging.structuredcontent.model.elements.basic']/class[@name='WebViewElement']/method[@name='getUrl' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.liveperson.messaging.structuredcontent.model.elements.basic']/class[@name='WebViewElement']/method[@name='accept' and count(parameter)=1 and parameter[1][@type='com.liveperson.messaging.structuredcontent.visitor.ElementVisitor']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.liveperson.messaging.structuredcontent.model.elements.basic']/class[@name='WebViewElement']/method[@name='toString' and count(parameter)=0]"
