...
namespace Com.Liveperson.Infra.UI.View.Uicomponents {
	...
	public partial interface IConversationProvider : IJavaObject {
		...
		string BrandId {
			...
			[Register ("getBrandId", "()Ljava/lang/String;", "GetGetBrandIdHandler:Com.Liveperson.Infra.UI.View.Uicomponents.IConversationProviderInvoker, LP_UI_Binding")] get;
		}
		...
		string TargetId {
			...
			[Register ("getTargetId", "()Ljava/lang/String;", "GetGetTargetIdHandler:Com.Liveperson.Infra.UI.View.Uicomponents.IConversationProviderInvoker, LP_UI_Binding")] get;
		}
