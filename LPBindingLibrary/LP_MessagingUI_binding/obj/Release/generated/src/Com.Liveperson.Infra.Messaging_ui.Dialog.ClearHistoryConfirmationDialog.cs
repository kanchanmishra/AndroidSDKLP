...
namespace Com.Liveperson.Infra.Messaging_ui.Dialog {
	...
	public partial class ClearHistoryConfirmationDialog : global::Android.App.DialogFragment {
		...
		public static unsafe global::Com.Liveperson.Infra.Messaging_ui.Dialog.ClearHistoryConfirmationDialog GetInstance (string targetId)
		{
			...
			try {
				...
				__args [0] = new JValue (native_targetId);
