...
namespace Com.Liveperson.Infra.Statemachine.Interfaces {
	...
	public partial interface IStateMachineExecutor : IJavaObject {
		...
		bool IsInitialized {
			...
			[Register ("isInitialized", "()Z", "GetIsInitializedHandler:Com.Liveperson.Infra.Statemachine.Interfaces.IStateMachineExecutorInvoker, LP_Infra_Binding")] get;
		}
		...
		[Register ("cancel", "(Ljava/lang/Runnable;)V", "GetCancel_Ljava_lang_Runnable_Handler:Com.Liveperson.Infra.Statemachine.Interfaces.IStateMachineExecutorInvoker, LP_Infra_Binding")]
		...
		[Register ("post", "(Lcom/liveperson/infra/statemachine/interfaces/IEvent;)V", "GetPost_Lcom_liveperson_infra_statemachine_interfaces_IEvent_Handler:Com.Liveperson.Infra.Statemachine.Interfaces.IStateMachineExecutorInvoker, LP_Infra_Binding")]
		...
		[Register ("schedule", "(Lcom/liveperson/infra/statemachine/interfaces/IEvent;J)Ljava/lang/Runnable;", "GetSchedule_Lcom_liveperson_infra_statemachine_interfaces_IEvent_JHandler:Com.Liveperson.Infra.Statemachine.Interfaces.IStateMachineExecutorInvoker, LP_Infra_Binding")]
		...
		[Register ("shutdown", "()V", "GetShutdownHandler:Com.Liveperson.Infra.Statemachine.Interfaces.IStateMachineExecutorInvoker, LP_Infra_Binding")]
		void Shutdown ();
