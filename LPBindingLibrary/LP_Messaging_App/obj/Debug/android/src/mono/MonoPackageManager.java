...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "LP_Messaging_App.dll" comes first in this list. */
		"LP_Messaging_App.dll",
		"LP_Android_aar_Binding.dll",
		...
		"Xamarin.Android.Support.Content.dll",
		...
		"Xamarin.Android.ViewPropertyObjectAnimator.dll",
