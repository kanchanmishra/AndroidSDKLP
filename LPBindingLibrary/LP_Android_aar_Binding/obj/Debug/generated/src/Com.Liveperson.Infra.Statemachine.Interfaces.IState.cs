...
namespace Com.Liveperson.Infra.Statemachine.Interfaces {
	...
	public partial interface IState : IJavaObject {
		...
		[Register ("actionOnEntry", "()V", "GetActionOnEntryHandler:Com.Liveperson.Infra.Statemachine.Interfaces.IStateInvoker, LP_Android_aar_Binding")]
		void ActionOnEntry ();
		...
		[Register ("actionOnExit", "()V", "GetActionOnExitHandler:Com.Liveperson.Infra.Statemachine.Interfaces.IStateInvoker, LP_Android_aar_Binding")]
		void ActionOnExit ();
