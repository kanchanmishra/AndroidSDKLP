...
#pragma warning restore 0169
			...
			static Delegate cb_handle_Lcom_liveperson_api_request_GetClock_Response_;
#pragma warning disable 0169
			static Delegate GetHandle_Lcom_liveperson_api_request_GetClock_Response_Handler ()
			{
				if (cb_handle_Lcom_liveperson_api_request_GetClock_Response_ == null)
					cb_handle_Lcom_liveperson_api_request_GetClock_Response_ = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, IntPtr, bool>) n_Handle_Lcom_liveperson_api_request_GetClock_Response_);
				return cb_handle_Lcom_liveperson_api_request_GetClock_Response_;
			}

			static bool n_Handle_Lcom_liveperson_api_request_GetClock_Response_ (IntPtr jnienv, IntPtr native__this, IntPtr native_p0)
			{
				global::Com.Liveperson.Messaging.Network.Socket.General_requests.ClockRequest.ClockResponseHandler __this = global::Java.Lang.Object.GetObject<global::Com.Liveperson.Messaging.Network.Socket.General_requests.ClockRequest.ClockResponseHandler> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
				global::Com.Liveperson.Api.Request.GetClock.Response p0 = global::Java.Lang.Object.GetObject<global::Com.Liveperson.Api.Request.GetClock.Response> (native_p0, JniHandleOwnership.DoNotTransfer);
				bool __ret = __this.Handle (p0);
				return __ret;
			}
#pragma warning restore 0169

			static IntPtr id_handle_Lcom_liveperson_api_request_GetClock_Response_;
			// Metadata.xml XPath method reference: path="/api/package[@name='com.liveperson.messaging.network.socket.general_requests']/class[@name='ClockRequest.ClockResponseHandler']/method[@name='handle' and count(parameter)=1 and parameter[1][@type='com.liveperson.api.request.GetClock.Response']]"
			[Register ("handle", "(Lcom/liveperson/api/request/GetClock$Response;)Z", "GetHandle_Lcom_liveperson_api_request_GetClock_Response_Handler")]
			protected new virtual unsafe bool Handle (global::Com.Liveperson.Api.Request.GetClock.Response p0)
			{
				if (id_handle_Lcom_liveperson_api_request_GetClock_Response_ == IntPtr.Zero)
					id_handle_Lcom_liveperson_api_request_GetClock_Response_ = JNIEnv.GetMethodID (class_ref, "handle", "(Lcom/liveperson/api/request/GetClock$Response;)Z");
				try {
					JValue* __args = stackalloc JValue [1];
					...
					bool __ret;
					if (((object) this).GetType () == ThresholdType)
						__ret = JNIEnv.CallBooleanMethod (((global::Java.Lang.Object) this).Handle, id_handle_Lcom_liveperson_api_request_GetClock_Response_, __args);
					else
						__ret = JNIEnv.CallNonvirtualBooleanMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "handle", "(Lcom/liveperson/api/request/GetClock$Response;)Z"), __args);
					return __ret;
				} finally {
				}
			}
...
#pragma warning restore 0169
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.liveperson.messaging.network.socket.general_requests']/class[@name='ClockRequest.ClockResponseHandler']/method[@name='parse' and count(parameter)=1 and parameter[1][@type='org.json.JSONObject']]"
			[Register ("parse", "(Lorg/json/JSONObject;)Lcom/liveperson/api/request/GetClock$Response;", "GetParse_Lorg_json_JSONObject_Handler")]
			protected virtual unsafe global::Com.Liveperson.Api.Request.GetClock.Response Parse (global::Org.Json.JSONObject p0)
			{
				if (id_parse_Lorg_json_JSONObject_ == IntPtr.Zero)
					id_parse_Lorg_json_JSONObject_ = JNIEnv.GetMethodID (class_ref, "parse", "(Lorg/json/JSONObject;)Lcom/liveperson/api/request/GetClock$Response;");
				try {
					JValue* __args = stackalloc JValue [1];
					__args [0] = new JValue (p0);

					global::Com.Liveperson.Api.Request.GetClock.Response __ret;
					if (((object) this).GetType () == ThresholdType)
						__ret = global::Java.Lang.Object.GetObject<global::Com.Liveperson.Api.Request.GetClock.Response> (JNIEnv.CallObjectMethod (((global::Java.Lang.Object) this).Handle, id_parse_Lorg_json_JSONObject_, __args), JniHandleOwnership.TransferLocalRef);
					else
						__ret = global::Java.Lang.Object.GetObject<global::Com.Liveperson.Api.Request.GetClock.Response> (JNIEnv.CallNonvirtualObjectMethod (((global::Java.Lang.Object) this).Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "parse", "(Lorg/json/JSONObject;)Lcom/liveperson/api/request/GetClock$Response;"), __args), JniHandleOwnership.TransferLocalRef);
					return __ret;
				} finally {
				}
			}
