...
namespace Com.Liveperson.Messaging.Commands.Tasks {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.liveperson.messaging.commands.tasks']/class[@name='LptagTask']"
	[global::Android.Runtime.Register ("com/liveperson/messaging/commands/tasks/LptagTask", DoNotGenerateAcw=true)]
	public partial class LptagTask : global::Com.Liveperson.Messaging.Commands.Tasks.BaseAmsAccountConnectionTask {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/liveperson/messaging/commands/tasks/LptagTask", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (LptagTask); }
		}

		protected LptagTask (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Lcom_liveperson_messaging_controller_AccountsController_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.liveperson.messaging.commands.tasks']/class[@name='LptagTask']/constructor[@name='LptagTask' and count(parameter)=1 and parameter[1][@type='com.liveperson.messaging.controller.AccountsController']]"
		[Register (".ctor", "(Lcom/liveperson/messaging/controller/AccountsController;)V", "")]
		public unsafe LptagTask (global::Com.Liveperson.Messaging.Controller.AccountsController p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (((object) this).GetType () != typeof (LptagTask)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Liveperson.Messaging.Commands.Tasks.LptagTask __this = global::Java.Lang.Object.GetObject<global::Com.Liveperson.Messaging.Commands.Tasks.LptagTask> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public override unsafe string Name {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.liveperson.messaging.commands.tasks']/class[@name='LptagTask']/method[@name='getName' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.liveperson.messaging.commands.tasks']/class[@name='LptagTask']/method[@name='execute' and count(parameter)=0]"
