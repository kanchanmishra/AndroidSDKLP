...
namespace Com.Liveperson.Sdk.Callbacks {
	...
	public partial interface IMonitoringCallback : IJavaObject {
		...
		[Register ("onError", "(Lcom/liveperson/monitoring/sdk/callbacks/MonitoringErrorType;Ljava/lang/Exception;)V", "GetOnError_Lcom_liveperson_monitoring_sdk_callbacks_MonitoringErrorType_Ljava_lang_Exception_Handler:Com.Liveperson.Sdk.Callbacks.IMonitoringCallbackInvoker, LP_Monitoring_Binding")]
		...
		[Register ("onSuccess", "()V", "GetOnSuccessHandler:Com.Liveperson.Sdk.Callbacks.IMonitoringCallbackInvoker, LP_Monitoring_Binding")]
		void OnSuccess ();
