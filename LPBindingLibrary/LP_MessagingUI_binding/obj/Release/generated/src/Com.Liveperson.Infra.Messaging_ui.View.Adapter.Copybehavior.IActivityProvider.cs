...
namespace Com.Liveperson.Infra.Messaging_ui.View.Adapter.Copybehavior {
	...
	public partial interface IActivityProvider : IJavaObject {
		...
		global::Android.App.Activity Activity {
			...
			[Register ("getActivity", "()Landroid/app/Activity;", "GetGetActivityHandler:Com.Liveperson.Infra.Messaging_ui.View.Adapter.Copybehavior.IActivityProviderInvoker, LP_MessagingUI_binding")] get;
		}
