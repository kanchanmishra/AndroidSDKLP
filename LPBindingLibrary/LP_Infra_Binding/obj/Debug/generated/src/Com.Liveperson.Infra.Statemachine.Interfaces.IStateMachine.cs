...
namespace Com.Liveperson.Infra.Statemachine.Interfaces {
	...
	public partial interface IStateMachine : IJavaObject {
		...
		string Tag {
			...
			[Register ("getTag", "()Ljava/lang/String;", "GetGetTagHandler:Com.Liveperson.Infra.Statemachine.Interfaces.IStateMachineInvoker, LP_Infra_Binding")] get;
		}
		...
		[Register ("activeState", "()Lcom/liveperson/infra/statemachine/interfaces/IState;", "GetActiveStateHandler:Com.Liveperson.Infra.Statemachine.Interfaces.IStateMachineInvoker, LP_Infra_Binding")]
		...
		[Register ("apply", "(Lcom/liveperson/infra/statemachine/interfaces/IEvent;)V", "GetApply_Lcom_liveperson_infra_statemachine_interfaces_IEvent_Handler:Com.Liveperson.Infra.Statemachine.Interfaces.IStateMachineInvoker, LP_Infra_Binding")]
		...
		[Register ("changeState", "(Lcom/liveperson/infra/statemachine/interfaces/IState;)V", "GetChangeState_Lcom_liveperson_infra_statemachine_interfaces_IState_Handler:Com.Liveperson.Infra.Statemachine.Interfaces.IStateMachineInvoker, LP_Infra_Binding")]
		...
		[Register ("initActiveState", "(Lcom/liveperson/infra/statemachine/interfaces/IState;)V", "GetInitActiveState_Lcom_liveperson_infra_statemachine_interfaces_IState_Handler:Com.Liveperson.Infra.Statemachine.Interfaces.IStateMachineInvoker, LP_Infra_Binding")]
		...
		[Register ("postDelayEvent", "(Lcom/liveperson/infra/statemachine/interfaces/IEvent;J)Ljava/lang/Runnable;", "GetPostDelayEvent_Lcom_liveperson_infra_statemachine_interfaces_IEvent_JHandler:Com.Liveperson.Infra.Statemachine.Interfaces.IStateMachineInvoker, LP_Infra_Binding")]
		...
		[Register ("postEvent", "(Lcom/liveperson/infra/statemachine/interfaces/IEvent;)V", "GetPostEvent_Lcom_liveperson_infra_statemachine_interfaces_IEvent_Handler:Com.Liveperson.Infra.Statemachine.Interfaces.IStateMachineInvoker, LP_Infra_Binding")]
		...
		[Register ("setStateMachineExecutor", "(Lcom/liveperson/infra/statemachine/interfaces/IStateMachineExecutor;)V", "GetSetStateMachineExecutor_Lcom_liveperson_infra_statemachine_interfaces_IStateMachineExecutor_Handler:Com.Liveperson.Infra.Statemachine.Interfaces.IStateMachineInvoker, LP_Infra_Binding")]
