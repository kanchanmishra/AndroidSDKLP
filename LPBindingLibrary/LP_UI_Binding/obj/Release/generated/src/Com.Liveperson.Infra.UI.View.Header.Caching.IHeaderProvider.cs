...
namespace Com.Liveperson.Infra.UI.View.Header.Caching {
	...
	public partial interface IHeaderProvider : IJavaObject {
		...
		[Register ("getHeader", "(Landroid/support/v7/widget/RecyclerView;I)Landroid/view/View;", "GetGetHeader_Landroid_support_v7_widget_RecyclerView_IHandler:Com.Liveperson.Infra.UI.View.Header.Caching.IHeaderProviderInvoker, LP_UI_Binding")]
		...
		[Register ("invalidate", "()V", "GetInvalidateHandler:Com.Liveperson.Infra.UI.View.Header.Caching.IHeaderProviderInvoker, LP_UI_Binding")]
		void Invalidate ();
