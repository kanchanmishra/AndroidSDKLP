...
namespace Com.Liveperson.Infra.Messaging_ui.Uicomponents.Inlinemessages {
	...
	public partial interface IInlineMessage : IJavaObject {
		...
		[Register ("hide", "()V", "GetHideHandler:Com.Liveperson.Infra.Messaging_ui.Uicomponents.Inlinemessages.IInlineMessageInvoker, LP_Android_aar_Binding")]
		void Hide ();
		...
		[Register ("show", "(Landroid/content/Context;Landroid/content/Intent;)V", "GetShow_Landroid_content_Context_Landroid_content_Intent_Handler:Com.Liveperson.Infra.Messaging_ui.Uicomponents.Inlinemessages.IInlineMessageInvoker, LP_Android_aar_Binding")]
